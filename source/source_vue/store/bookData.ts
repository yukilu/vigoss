...
export const BOOKS_READED: BookLi[] = [
    {
...
export const BOOKS_READING: BookLi[] = [
    {
        name: 'CSS揭秘',
        src: 'CSS_Secrets.jpg',
...
export const BOOKS_TO_READ: BookLi[] = [
    {
...
export function getTags(books: BookLi[]): string[] {
    const tgs: string[] = [];
