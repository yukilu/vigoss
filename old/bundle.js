...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connectAdvanced__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_connectAdvanced__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrapMapToProps__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(30);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
const outPoems = [{ "_id": 0, "title": "陶者", "author": "梅尧臣", "content": ["陶尽门前土，屋上无片瓦。", "十指不沾泥，鳞鳞居大厦。"] }, { "_id": 1, "title": "书湖阴先生壁二首 其一", "author": "王安石", "content": ["茅檐长扫净无苔，花木成畦手自栽。", "一水护田将绿绕，两山排闼送青来。"] }, { "_id": 2, "title": "夏日绝句", "author": "李清照", "content": ["生当作人杰，死亦为鬼雄。", "至今思项羽，不肯过江东。"] }];

const thunkMiddleware = store => next => action => typeof action === 'function' ? action(store.dispatch, store.getState) : next(action);

const store = (0, _redux.createStore)(reducer, (0, _redux.applyMiddleware)(thunkMiddleware));
const actions = {
...
let Poetry = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = class Poetry extends _react2.default.Component {
    render() {
        let props = this.props;
        const poems = props.poems.map(poem => React.createElement(Poem, { key: poem._id, poem: poem }));
        return React.createElement(
            'div',
            { onClick: props.get, style: { textAlign: 'center' } },
            poems
        );
    }
}) || _class);
...
(0, _reactDom.render)(React.createElement(
    ...
    { store: store },
    React.createElement(Poetry, null)
